...
async def test_speedlogic_url():
    ...
    print("Probando análisis de SpeedLogic")
    print("=" * 50)
    ...
    async with httpx.AsyncClient(timeout=60.0) as client:
        try:
            ...
            if response.status_code == 200:
                ...
                meta = data['meta']
                print("METADATOS:")
                print(f"   Título: {meta['title'][:80]}..." if meta['title'] else "   Título: No encontrado")
                print(f"   Descripción: {meta['description'][:100]}..." if meta['description'] else "   Descripción: No encontrada")
...
async def main():
    """Función principal."""
    print("PRUEBA ESPECÍFICA - SPEEDLOGIC")
    print("=" * 60)
    ...
    if success:
        ...
        print("El sistema analizó correctamente la URL de SpeedLogic")
    else:
